...
A violin plot of data limited to a minimum year. 
The violins are accompanied by data points dots to the left for each month.
...
There are really many ways of representing and analyzing this data.
